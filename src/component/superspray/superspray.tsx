        ...
        <div className="rounded-3xl border bg-white p-8 shadow-lg">
          ...
          <div className="mb-4 flex items-center justify-between">
            ...
            <div className="flex gap-2">
              <Button className="flex items-center gap-2 rounded-full [background-color:#FF5079] hover:opacity-90 px-4 py-2 text-white">
                <svg
                  width="16"
                  height="16"
                  viewBox="0 0 16 16"
              ...
              <Button variant="outline" className="flex items-center gap-2 rounded-full px-4 py-2 text-gray-700">
                <svg
                  width="16"
                  height="16"
                  viewBox="0 0 16 16"
          ...
          {/* Submit Button */}
          <Button
            className="w-full rounded-xl [background-color:#FF5079] hover:opacity-90 py-4 text-lg font-semibold text-white disabled:opacity-50"
            onClick={handleSpray}
